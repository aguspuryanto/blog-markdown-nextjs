...
import { Settings, Save, X, Bell, Lock, Palette, Globe, Mail, User } from 'lucide-react';
          ...
          <div className="p-6 space-y-6">
            <div>
              ...
              <select
                ...
                className="w-full md:w-64 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
              >
